...
public class garageClient {
	...
	public static void main(String[] args) {
		mainClass.println("Welcome to Jazy's Garage creator!");
		createGarage();
		keyListener.wait(2300);
		mainClass.reset();
	}
	
	public static void createGarage(){
		mainClass.printf("Enter a new garage name: ");
